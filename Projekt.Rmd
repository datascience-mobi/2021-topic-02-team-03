...
#4.3 Selecting skin specific TRA in the expression matrix
```{r}
## Selecting skin specific TRA in the expression matrix for HUMANS
...
#4.6 Heatmap for the purpose of correlation visualization
```{r}
...
#4.7. Skin-specific antigens extraction from gene expression df
