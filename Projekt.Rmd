...
logFC_sherk_top = logFC_sherk[1:10]
...
display_venn <- function(x, y, z){
  grid.newpage()
  venn_object = venn.diagram(x, filename = NULL, main = "Potential drug targets", category.names = y, fill = z)
  grid.draw(venn_object)
}

display_venn(list(A = upreg_all, B = skin.genes.human), c("Upregulated genes" , "TRA"), c("#0073C2FF", "#EFC000FF"))
...
```{r}
#Find the most variable upregulated genes?
