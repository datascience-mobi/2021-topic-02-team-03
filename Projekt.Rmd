...
#k-means Clustering
fviz_cluster(km.both, data = both, palette = c("orange", "blue", "green"), geom = "point", ellipse.type = "convex", ggtheme = theme_bw())
#Hierarchical Clustering
fviz_dend(hclust(dist(both)), k = 3, k_colors = c("orange", "blue", "green"),
...
##Silhouette method
fviz_nbclust(updown, kmeans, method = "silhouette")+labs(subtitle = "Silhouette method")
##Gap statistic
fviz_nbclust(updown, kmeans, nstart = 25, method = "gap_stat", nboot = 50)
##NbClust
nb.updown = NbClust(updown, distance = "euclidean", min.nc = 2,
max.nc = 10, method = "kmeans")+labs(subtitle = "NbClust")
fviz_nbclust(nb.updown)

#Clusterable?
hopkins(both, n = nrow(both)-1)
#Silhouette plot for validation
km.updown = kmeans(updown, centers = 4, nstart = 25)
