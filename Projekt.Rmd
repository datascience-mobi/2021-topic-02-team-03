...
setwd("/Users/christofer.richard/Desktop/DA 2.3/Bioinformatik TRA Projekt/The role of skin specific genes in skin cancer/tables")
...
chromosome_1 = TRA_Human_Novartis[,7]
chromosome_skin1 = chromosome_1[ind1]

chromosome_2 = TRA_Human_protien_atlas[,2]
chromosome_skin2 = chromosome_2[ind2]

chromosome_3 = TRA_Human_gtex[,6]
chromosome_skin3 = chromosome_3[c(ind3.s, ind3.ns)]

##Combine all chromosome numbers for skin-specific human TRAs in a vector
chromosome_skin_human = c(chromosome_skin1, chromosome_skin2, chromosome_skin3)
length(chromosome_skin_human)
#1070
chromosome_skin_human = na.omit(chromosome_skin_human[chromosome_skin_human != ""])
length(chromosome_skin_human)
#1012
...
#i cant seem to figure out how to put all these values i printed out in a vector, so the following barplot wont work with this code; if you want to see how it's supposed to look you can put this instead: chromosome_counts = c(50:73)
chromosome_counts = for (l in c(1:22, "X", "Y")) {
  k = 0
  for (i in 1:length(chromosome_skin_human)) {
    if (chromosome_skin_human[i] == l) {
    k = k + 1
    }
  }
  print(k)
...
pie(sort(your data table or something), col = rainbow(20), main = "Portion of skin-specific TRAs from all human TRAs")
