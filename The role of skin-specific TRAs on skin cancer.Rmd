...
mpzl3_lr = lm(MPZL3 ~ DCT+DSP+ANXA2, data = data.frame(t(data.skin.cancer.human_skin_TRA)))
summary(mpzl3_lr)
...
arhgef5_lr = lm(ARHGEF5 ~ DCT+GJA1+ANXA2, data = data.frame(t(data.skin.cancer.human_skin_TRA)))
summary(arhgef5_lr)
