...
#Genes that have a high correlation will be considered as they have the same impact on the upregulated genes. ANXA2, DCT, PTPRZ1, TGFBI, TYRP1 will be considered as one gene. NDRG1 and PPP1R14C will be considered as one gene. (5 genes from PCA used in total)
...
#ANXA2, DCT, PTPRZ1, TGFBI, TYRP1
#DSP, GJA1, NDRG1, PPP1R14C, SPINT2, UCN2
...
#all = data.frame(data.skin.cancer.human_skin_TRA[unique(c(upreg_sherk_significant, upreg_erk12_significant, upreg_trametinib_significant, top_genes_pca1, top_genes_pca2)),])
```
